...
export default class CoursesItem extends Component {
  ...
  render() {
    return (    
        <React.Fragment>
          <div className="one-frames-courses no-gutters ">
              <a href={"/quiz"} style={{textDecoration: 'none', color: 'black'}} className="row">
                  <div className="col-sm-3 col-xs-3 img-courses">
                  <img src={".." + this.props.images} className="img-fluid" alt = "anh chu de"/>
                  </div>
