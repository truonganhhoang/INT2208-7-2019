		...
		<div class="col-sm-8">
			<div class="container-wrap" class="tlid-input-area input-area less-padding">
  				...
  				<form method="POST">
					...
					<h3>						
						<textarea name ="dulieu" class="form-control"  class="orig tlid-source-text-input goog-textarea" rows="1" spellcheck="false" autocapitalize="off" autocomplete="off" autocorrect="off" style="overflow: auto hidden; box-sizing: border-box; max-height: 300px; direction: ltr; padding-bottom: 80px;"><?php if (isset($_POST['submit'])) {
							echo $_POST['dulieu'];
						} ?></textarea>	
						<input type="submit" name="submit" value="Dịch" style=" position: relative;border-radius: 20px 20px 20px 20px;height: 30px;width: 60px;min-width: 60px;font-size: 18px; border: none;outline: none;margin-top: 20px;margin-left: 20px;cursor: pointer;background: #23415C; color: #fff;left: -5px;box-shadow: 0 0 0 7px #23415C;">
					</h3>
				</form>
			</div>
		</div>
