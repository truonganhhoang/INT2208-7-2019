				...
				<div class="user_right col-md-9">
					...
					<div>
						<div class="mt-5" style="border: 1px solid #ddd; ">
							<div class="title_tab">
								<div class="title_header">Sản phẩm bạn đã thích</div>
								<br class="clear"> 
							</div>
							...
							<div class="sp_moi">
								<ul class="listsp">
									<?php
									include 'connect.php';
									$tentaikhoan1 = $tentaikhoan.'fake';
									$query = mysqli_query($con,"SELECT * FROM danhgia WHERE username = '$tentaikhoan1' AND like_sp = 1");
									if($query->num_rows > 0){
										...
										<p class="ml-4 mt-4" style="display: -webkit-inline-box;">Bạn chưa thích sản phẩm nào</p>
										<?php
									} ?>
								</ul>
							</div>
